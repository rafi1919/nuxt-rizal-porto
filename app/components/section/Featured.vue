...
<template>
  <div class="bg-black text-white px-8 py-12 relative">

    <div class="flex justify-between text-[10px] uppercase tracking-[0.16em] text-white/30 mb-2">
      <span>Featured Work</span><span>代表作</span>
    </div>
    <h2 class="text-2xl font-semibold text-white mb-8 max-w-md leading-snug">
    ...
    <div class="border-t border-white/10">
      ...
      >
        <div class="flex items-center gap-5">
          <span class="text-[11px] tabular-nums text-white/20 group-hover:text-[#F12E03] transition-colors duration-250">
            0{{ index + 1 }}
          </span>
